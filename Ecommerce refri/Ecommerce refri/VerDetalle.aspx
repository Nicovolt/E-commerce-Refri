<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerDetalle.aspx.cs" Inherits="Ecommerce_refri.Formulario_web1" %>
                ...
                <div class="col-md-6" style="display: flex; flex-direction: column; justify-content: space-around; color: #000000">
                    ...
                    <div style="display: flex; flex-direction: column;">
                        ...
                        <div>
                            ...
                            <asp:Button ID="btnCarrito" onclick="btnCarrito_Click"  Text="Agregar al carrito" CssClass="btn btn-success" runat="server" />
                            <asp:Button ID="btnBorrar" CommandName="idBorrar" OnClick="btnBorrar_Click" OnClientClick="return confirmDelete();" Text ="Eliminar" runat="server" CssClass="btn btn-danger"/>
                            <asp:Button ID="btnModificar"  Text="Modificar" CommandName="idModificar" OnClick="btnModificar_Click" runat="server" CssClass="btn btn-primary"/>
                        </div>
                    </div>
                </div>
